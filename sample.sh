#!/bin/bash
# python sample.py --restore_path model_output/boy1 --prompt_path eval_prompts/boy1.json --output_path outputs/boy1 --weight_dir model_output/boy1
...
# python sample.py --restore_path /data/hdd3/schengwei/moutput/girl2_3000 --prompt_path /home/schengwei/Competitionrepo/eval_prompts_advance/girl2_sim.json --output_path /data/hdd3/schengwei/outputs/girl2_sim
