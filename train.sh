...
#!/bin/bash
accelerate launch --mixed_precision no --num_processes 1 trainn.py --instance_data_dir="train_data/newboy1"  --outdir="model_output/boy11"  --class_data_dir="real_reg/samples_boyface"   --with_prior_preservation  --prior_loss_weight=1.0  --class_prompt="boy" --num_class_images=200  --instance_prompt=" a <new1> boy"  --modifier_token "<new1>"
