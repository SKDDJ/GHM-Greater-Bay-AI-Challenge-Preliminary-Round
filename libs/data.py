...
def collate_wrapper(examples, with_prior_preservation):
    return collate_fn(examples, with_prior_preservation)
...
class PersonalizedBase(Dataset):
    ...
    def __getitem__(self, index):
        ...
        instance_image = self.preprocess(instance_image, random_scale, self.interpolation)
